 ...
 * @returns {string}
 */
export function hello_world(input) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.hello_world(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
export class Board {
     ...
     */
    static new(rc, cc) {
        const ret = wasm.board_new(rc, cc);
    ...
    step(board) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.board_step(this.__wbg_ptr, ptr0, len0);
     ...
     */
    get_turn_on_idxs() {
        const ret = wasm.board_get_turn_on_idxs(this.__wbg_ptr);
     ...
     */
    get_turn_off_idxs() {
        const ret = wasm.board_get_turn_off_idxs(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('logic_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
