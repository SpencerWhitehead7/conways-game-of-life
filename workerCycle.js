...
Comlink.expose({
  ...
  init: function (rowCount, colCount, board) {
    ...
    this.step = (board) => {
      ...
      // const turnOn = createUpdateNeighbors(rowCount, colCount, 1, nextBoard);
      // const turnOff = createUpdateNeighbors(rowCount, colCount, -1, nextBoard);
